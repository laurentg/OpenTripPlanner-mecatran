...
public class TestBikeRental extends TestCase {
    public void testBasic() throws Exception {
        ...
        new RentABikeOnEdge(stationVertex, stationVertex, "network");
        new RentABikeOffEdge(stationVertex, stationVertex, "network");
        ...
        new RentABikeOnEdge(stationVertex2, stationVertex2, "network");
        new RentABikeOffEdge(stationVertex2, stationVertex2, "network");
