...
package com.mecatran.otp;

import org.opentripplanner.common.model.P2;
import org.opentripplanner.graph_builder.impl.osm.CreativeNamer;
import org.opentripplanner.graph_builder.impl.osm.DefaultWayPropertySetSource;
import org.opentripplanner.graph_builder.impl.osm.NoteProperties;
...
import org.opentripplanner.graph_builder.impl.osm.WayPropertySetSource;
import org.opentripplanner.routing.edgetype.StreetTraversalPermission;

/**
 * A default WayPropertySetSource adapted to French language and road network.
 *
 * @see DefaultWayPropertySetSource
 */
public class MecatranWayPropertySetSource implements WayPropertySetSource {
    ...
    public WayPropertySet getWayPropertySet() {
        ...
        createNotes(props, "RLIS:bicycle=caution_area", "Attention!");
        createNotes(props, "CCGIS:bicycle=caution_area", "Attention!");
        createNotes(props, "surface=unpaved", "Surface non pavée");
        createNotes(props, "surface=compacted", "Surface non pavée");
        createNotes(props, "surface=ground", "Surface non pavée");
        createNotes(props, "surface=dirt", "Surface non pavée");
        createNotes(props, "surface=earth", "Surface non pavée");
        createNotes(props, "surface=grass", "Surface non pavée");
        createNotes(props, "surface=mud", "Surface non pavée-- boue!");

        /* and some names */
        // Basics
        createNames(props, "highway=cycleway", "piste cyclable");
        createNames(props, "cycleway=track", "piste cyclable");
        createNames(props, "highway=pedestrian", "chemin");
        createNames(props, "highway=path", "chemin");
        createNames(props, "highway=footway", "chemin");
        createNames(props, "highway=bridleway", "piste cavalière");
        createNames(props, "highway=footway;bicycle=no", "chemin piétonnier");

        // Platforms
        createNames(props, "otp:route_ref=*", "Route {otp:route_ref}");
        createNames(props, "highway=platform;ref=*", "Plate-forme {ref}");
        createNames(props, "railway=platform;ref=*", "Plate-forme {ref}");
        createNames(props, "railway=platform;highway=footway;footway=sidewalk", "plate-forme");
        createNames(props, "railway=platform;highway=path;path=sidewalk", "plate-forme");
        createNames(props, "railway=platform;highway=pedestrian", "plate-forme");
        createNames(props, "railway=platform;highway=path", "plate-forme");
        createNames(props, "railway=platform;highway=footway", "plate-forme");
        createNames(props, "highway=platform", "plate-forme");
        createNames(props, "railway=platform", "plate-forme");
        createNames(props, "railway=platform;highway=footway;bicycle=no", "plate-forme");

        // Bridges/Tunnels
        createNames(props, "highway=pedestrian;bridge=*", "passerelle piéton");
        createNames(props, "highway=path;bridge=*", "passerelle piéton");
        createNames(props, "highway=footway;bridge=*", "passerelle piéton");

        createNames(props, "highway=pedestrian;tunnel=*", "tunnel");
        createNames(props, "highway=path;tunnel=*", "tunnel");
        createNames(props, "highway=footway;tunnel=*", "tunnel");

        // Basic Mappings
        createNames(props, "highway=motorway", "route");
        createNames(props, "highway=motorway_link", "bretelle d'accès");
        createNames(props, "highway=trunk", "route");
        createNames(props, "highway=trunk_link", "bretelle d'accès");

        createNames(props, "highway=primary", "route");
        createNames(props, "highway=primary_link", "route");
        createNames(props, "highway=secondary", "route");
        createNames(props, "highway=secondary_link", "route");
        createNames(props, "highway=tertiary", "route");
        createNames(props, "highway=tertiary_link", "link");
        createNames(props, "highway=unclassified", "route");
        createNames(props, "highway=residential", "route");
        createNames(props, "highway=living_street", "route");
        createNames(props, "highway=road", "route");
        createNames(props, "highway=service", "route de service");
        createNames(props, "highway=service;service=alley", "allée");
        createNames(props, "highway=service;service=parking_aisle", "allée de parking");
        createNames(props, "highway=byway", "route secondaire");
        createNames(props, "highway=track", "chemin");

        createNames(props, "highway=footway;footway=sidewalk", "trottoir");
        createNames(props, "highway=path;path=sidewalk", "trottoir");

        createNames(props, "highway=steps", "escalier");
